...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { gee_id: @field.gee_id, max_value: @field.max_value, min_value: @field.min_value, name: @field.name, type: @field.type } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { gee_id: @field.gee_id, max_value: @field.max_value, min_value: @field.min_value, name: @field.name, type: @field.type } }
