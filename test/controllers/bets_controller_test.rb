...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { gee_id: @bet.gee_id, quantity: @bet.quantity, user_id: @bet.user_id } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { gee_id: @bet.gee_id, quantity: @bet.quantity, user_id: @bet.user_id } }
